package com.gerardoleonel.projectuts_eventorganizer.geolocation;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private FloatingActionButton btnStart, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStart = findViewById(R.id.fab_direction);
        btnBack = findViewById(R.id.fab_back_button);
        ...
        mapboxMap.setStyle(new Style.Builder().fromUri(styleOption),
                new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        options.title(getString(R.string.filography));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == REQUEST_CODE_AUTOCOMPLETE) {
            ...
            if (mapboxMap != null) {
                ...
                if (style != null) {
                    GeoJsonSource source = style.getSourceAs(getString(R.string.geoJsonSourceLayerId));
                    if (source != null) {
